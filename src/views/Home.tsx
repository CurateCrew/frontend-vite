...
const Home = () =>{
  ...
  return (
    <div className='flex flex-col mx-auto w-full lg:justify-center lg:items-center min-h-screen' onClick={() => setOpenNav(false)}>
     
      <div className='grid grid-cols-3 justify-between m-2'>
        <img className='rounded-full lg:hidden md:block' src={auth.profile.pfpUrl} alt={auth.profile.username} width={36} onClick={() => setOpenNav(true)} />
      ...
      <NavDrawer show={openNav}/>
        ...
        <div className="grid lg:grid-cols-12 md:grid-cols-1 mx-auto justify-between lg:w-11/12 w-full bg-white rounded-xl overflow-hidden">
            <div className='col-span-2'>
              <LeftSideBar/>
            </div>
            <div className='lg:col-span-6 lg:border-l lg:border-r'>
