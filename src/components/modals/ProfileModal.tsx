          ...
          <div className="relative w-full max-w-md h-full md:h-auto p-4">
            <div className="relative bg-white rounded-lg shadow">
              <div className="flex justify-between p-4">
                <img className="rounded-full" src={profileImage} width={48} />
              ...
              <div className="p-4">
                ...
                <p>@yele</p>
                <p className="mt-2">
                  Contributor #001 @onboard, an onchain p2p protocol that’s
                  creating a universally accessible gateway to the global
                  onchain economy for everyone
                </p>
